...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var tempSum = sum(a, b)[0];
  var finalSum = sum(tempSum, c)[0];
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + finalSum + '.';

  var tempProduct = multiply(a, b)[0];
  var finalProduct = multiply(tempProduct, c)[0];
  var producMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + finalProduct + '.';

  return [finalSum, finalProduct, sumMessage, producMessage];
}
